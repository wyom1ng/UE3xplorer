...
public partial class TextureViewer : Window
{
  private UTexture2D texture;
    ...
    void InitializeDevice()
    {
        ...
        var vertexShaderByteCode = ShaderBytecode.CompileFromFile("Shaders/Texture.fx", "VS", "vs_4_0", ShaderFlags.None, EffectFlags.None);
        var vertexShader = new D3D11.VertexShader(device, vertexShaderByteCode);

        var pixelShaderByteCode = ShaderBytecode.CompileFromFile("Shaders/Texture.fx", "PS", "ps_4_0", ShaderFlags.None, EffectFlags.None);
